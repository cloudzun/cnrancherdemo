az group create --name cnrancherdemo --location southeastasia
...
az vm create --resource-group cnrancherdemo --name ranchersrv1 --public-ip-address-dns-name ranchersrv1 --image UbuntuLTS --admin-username chengzh --generate-ssh-keys --size  Standard_D4s_v3 --custom-data node.txt
az vm open-port --resource-group cnrancherdemo --name ranchersrv1 --port 0-65535 --priority 1001

az vm create --resource-group cnrancherdemo --name ranchersrv2 --public-ip-address-dns-name ranchersrv2 --image UbuntuLTS --admin-username chengzh --generate-ssh-keys --size  Standard_D4s_v3 --custom-data node.txt
az vm open-port --resource-group cnrancherdemo --name ranchersrv2 --port 0-65535 --priority 1001

az vm create --resource-group cnrancherdemo --name ranchersrv3 --public-ip-address-dns-name ranchersrv3 --image UbuntuLTS --admin-username chengzh --generate-ssh-keys --size  Standard_D4s_v3 --custom-data node.txt
